...
- **邮箱接入**：支持 Cloudflare、YYDS 和 Outlook / Microsoft OAuth 邮箱池，自动匹配 Graph 或 Thunderbird IMAP 令牌。
...
| `ms_mail_file` | Outlook 四段 OAuth 邮箱池文件，建议放在 `fixtures/` |
